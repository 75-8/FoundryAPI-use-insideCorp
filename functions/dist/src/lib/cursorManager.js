...
exports.buildCursorBlobName = buildCursorBlobName;
 ...
 */
function buildCursorBlobName(diagnosticBlobPath) {
 ...
 */
async function readCursor(cursorContainer, diagnosticBlobPath) {
 ...
 */
async function writeCursor(cursorContainer, diagnosticBlobPath, offset) {
    const cursorBlobName = buildCursorBlobName(diagnosticBlobPath);
